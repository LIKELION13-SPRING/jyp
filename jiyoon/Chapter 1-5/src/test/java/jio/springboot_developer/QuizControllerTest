...
class QuizControllerTest {
    ...
    @Autowired
    private ObjectMapper objectMapper; // 객체와 JSON 간의 변환
    ...
    @DisplayName("quiz(): GET /quiz?code=2 이면 응답 코드는 403, 응답 본문은 Forbidden!를 리턴한다.")
    @Test
    ...
    @DisplayName("quiz(): POST /quiz with code=13 이면 응답 코드는 200, 응답 본문은 OK!를 리턴한다.")
    @Test
